...
class AsImageLoaderTest extends TestCase
{
    public function testStoresName(): void
    {
        $attribute = new AsImageLoader('filesystem');

        self::assertSame('filesystem', $attribute->name);
    }

    public function testIsTargetClass(): void
    {
        $reflector = new ReflectionClass(AsImageLoader::class);
